...
> 영향 INF 16건 중 관련도 상위 16건. 편재 공통자원은 하단 별도 격리.
...
- **INF-MBR-002** `0.08` (MEMBERS)  POST /api/members/signup  ·  docs/05_설계서/member/INF/INF-MBR-002.md
...
- **INF-ORD-001** `0.08` (MEMBERS)  GET /api/members/  ·  docs/05_설계서/order/INF/INF-ORD-001.md
