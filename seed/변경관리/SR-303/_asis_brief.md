...
요청 엔티티: PRODUCTS, 상품, 목록, 상품, 상세, /api/products
...
- **INF-ORD-004** `0.09` (PRODUCTS)  GET /api/orders/{orderNo}  ·  docs/05_설계서/order/INF/INF-ORD-004.md
...
- **INF-ORD-005** `0.09` (PRODUCTS)  POST /api/orders  ·  docs/05_설계서/order/INF/INF-ORD-005.md
...
- **INF-ORD-006** `0.09` (PRODUCTS)  PATCH /api/orders/{orderNo}/cancel  ·  docs/05_설계서/order/INF/INF-ORD-006.md
...
- **INF-ORD-007** `0.09` (PRODUCTS)  GET /api/orders/{orderNo}/deliveries  ·  docs/05_설계서/order/INF/INF-ORD-007.md
...
- **INF-ORD-014** `0.09` (PRODUCTS)  POST /api/cart/checkout  ·  docs/05_설계서/order/INF/INF-ORD-014.md
