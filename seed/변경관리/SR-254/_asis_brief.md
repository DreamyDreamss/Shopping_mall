...
- **INF-ORD-004** `0.20` (MEMBERS)  GET /api/orders/{orderNo}  ·  docs/05_설계서/order/INF/INF-ORD-004.md
...
- **INF-ORD-005** `0.20` (MEMBERS)  POST /api/orders  ·  docs/05_설계서/order/INF/INF-ORD-005.md
...
- **INF-ORD-006** `0.20` (MEMBERS)  PATCH /api/orders/{orderNo}/cancel  ·  docs/05_설계서/order/INF/INF-ORD-006.md
...
- **INF-ORD-007** `0.20` (MEMBERS)  GET /api/orders/{orderNo}/deliveries  ·  docs/05_설계서/order/INF/INF-ORD-007.md
