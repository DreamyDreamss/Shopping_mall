...
요청 엔티티: cart_items, orders, order_items, products, 장바구니, 주문, 상세

> 요약 스펙 본문 대신 **소스앵커**를 싣는다. 에이전트는 아래 file:line을 Read하여 최신·정밀 AS-IS를 확보한다.
> 영향 INF 13건 중 관련도 상위 13건. 편재 공통자원은 하단 별도 격리.
...
- **INF-ORD-011** `0.90` (화면 UIS-ORD-005)  GET /api/cart/  ·  docs/05_설계서/order/INF/INF-ORD-011.md
    ...
    - 소스: `src/main/resources/mapper/member.xml:14-19`
- **INF-ORD-012** `0.25` (PRODUCTS)  PATCH /api/cart/items/{sku}  ·  docs/05_설계서/order/INF/INF-ORD-012.md
    ...
    - 소스: `src/main/resources/mapper/product.xml:18-22`
- **INF-ORD-013** `0.25` (PRODUCTS)  DELETE /api/cart/items/{sku}  ·  docs/05_설계서/order/INF/INF-ORD-013.md
...
- **INF-ORD-002** `0.17` (MEMBERS)  GET /api/members/{memberId}  ·  docs/05_설계서/order/INF/INF-ORD-002.md
...
- **INF-ORD-001** `0.11` (MEMBERS)  GET /api/members/  ·  docs/05_설계서/order/INF/INF-ORD-001.md
...
- **UIS-ORD-004** 상품 상세 `/product/{sku}`  ·  연결 INF: INF-ORD-009, INF-ORD-010  ·  docs/05_설계서/order/UIS/UIS-ORD-004_상품상세/spec.md
    ...
    - 소스: `{{SRC_SHOP_API}}/src/main/java/com/sm/lab/shop/controller/ProductViewController.java`
- **UIS-ORD-005** 장바구니 `/cart`  ·  연결 INF: INF-ORD-010, INF-ORD-011  ·  docs/05_설계서/order/UIS/UIS-ORD-005_장바구니/spec.md
    - 소스: `"src/main/resources/templates/cart/list.html"`
    - 소스: `"src/main/java/com/sm/lab/shop/controller/CartViewController.java:34-47"`
    - 소스: `"src/main/java/com/sm/lab/shop/controller/CartViewController.java:50-54"`
    - 소스: `"src/main/java/com/sm/lab/shop/controller/CartViewController.java:57-61"`
...
## 영향 테이블
CART_ITEMS, MEMBERS, ORDERS, ORDER_DELIVERY, ORDER_ITEMS, PRODUCTS
