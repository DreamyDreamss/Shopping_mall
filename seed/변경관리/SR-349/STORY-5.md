...
spec_markers: 0
sr-id: SR-349
approved_sha: 551cc42c3fc5
---

# STORY-SR-349.5 — [기능점검A] 주문 목록 배송 상태 필터 — 주문 테이블 상태 컬럼

## Story
[기능점검A] 주문 목록 배송 상태 필터 — 주문 테이블 상태 컬럼
...
- **SR-349 #3** GET /api/members/ — 회원 목록 조회 — Approved

## 수용 기준 (Acceptance Criteria)
**변경(TO-BE) — 이 SR이 바꾸는 것** (`docs/변경관리/SR-349/02_변경명세.md`에서 도출)
- [ ] SCH-ORD-004: [미상] — 위 SR-349 절의 요지 중 이 스펙에 해당하는 변경을 사람이 적는다
