...
- **INF-ORD-014** `0.20` (MEMBERS)  POST /api/cart/checkout  ·  docs/05_설계서/order/INF/INF-ORD-014.md
...
- **INF-ORD-002** `0.12` (MEMBERS)  GET /api/members/{memberId}  ·  docs/05_설계서/order/INF/INF-ORD-002.md
...
- **INF-ORD-010** `0.09` (MEMBERS)  POST /api/cart/items  ·  docs/05_설계서/order/INF/INF-ORD-010.md
...
- **INF-ORD-011** `0.09` (MEMBERS)  GET /api/cart/  ·  docs/05_설계서/order/INF/INF-ORD-011.md
