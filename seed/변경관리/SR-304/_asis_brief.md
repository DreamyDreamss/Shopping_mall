...
요청 엔티티: PRODUCTS, 상품, 상세, 장바구니, /api/cart/, /api/cart/items, /api/products, /api/products/{sku}
...
- **INF-ORD-010** `1.00` ((직접))  POST /api/cart/items  ·  docs/05_설계서/order/INF/INF-ORD-010.md
...
- **INF-ORD-011** `1.00` ((직접))  GET /api/cart/  ·  docs/05_설계서/order/INF/INF-ORD-011.md
    ...
    - 소스: `src/main/resources/mapper/member.xml:14-19`
- **INF-ORD-012** `1.00` ((직접))  PATCH /api/cart/items/{sku}  ·  docs/05_설계서/order/INF/INF-ORD-012.md
    ...
    - 소스: `src/main/resources/mapper/product.xml:18-22`
- **INF-ORD-013** `1.00` ((직접))  DELETE /api/cart/items/{sku}  ·  docs/05_설계서/order/INF/INF-ORD-013.md
...
- **INF-ORD-014** `1.00` ((직접))  POST /api/cart/checkout  ·  docs/05_설계서/order/INF/INF-ORD-014.md
