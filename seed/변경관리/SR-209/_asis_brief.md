...
> 영향 INF 11건 중 관련도 상위 11건. 편재 공통자원은 하단 별도 격리.
...
- **INF-ORD-004** `0.12` (MEMBERS)  GET /api/orders/{orderNo}  ·  docs/05_설계서/order/INF/INF-ORD-004.md
...
- **INF-ORD-005** `0.12` (MEMBERS)  POST /api/orders  ·  docs/05_설계서/order/INF/INF-ORD-005.md
...
- **INF-ORD-006** `0.12` (MEMBERS)  PATCH /api/orders/{orderNo}/cancel  ·  docs/05_설계서/order/INF/INF-ORD-006.md
...
- **INF-ORD-007** `0.12` (MEMBERS)  GET /api/orders/{orderNo}/deliveries  ·  docs/05_설계서/order/INF/INF-ORD-007.md
...
- **INF-ORD-014** `0.12` (MEMBERS)  POST /api/cart/checkout  ·  docs/05_설계서/order/INF/INF-ORD-014.md
...
- **INF-ORD-015** `0.12` (MEMBERS)  GET /api/orders/export  ·  docs/05_설계서/order/INF/INF-ORD-015.md
