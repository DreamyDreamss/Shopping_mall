...
- **INF-ORD-004** `0.12` (ORDERS)  GET /api/orders/{orderNo}  ·  docs/05_설계서/order/INF/INF-ORD-004.md
...
- **INF-ORD-005** `0.12` (ORDERS)  POST /api/orders  ·  docs/05_설계서/order/INF/INF-ORD-005.md
...
- **INF-ORD-006** `0.12` (ORDERS)  PATCH /api/orders/{orderNo}/cancel  ·  docs/05_설계서/order/INF/INF-ORD-006.md
...
- **INF-ORD-007** `0.12` (ORDERS)  GET /api/orders/{orderNo}/deliveries  ·  docs/05_설계서/order/INF/INF-ORD-007.md
...
- **INF-ORD-014** `0.12` (ORDERS)  POST /api/cart/checkout  ·  docs/05_설계서/order/INF/INF-ORD-014.md
