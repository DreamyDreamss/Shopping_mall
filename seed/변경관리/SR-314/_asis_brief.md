...
- **INF-ORD-010** `0.90` (화면 UIS-ORD-010)  POST /api/cart/items  ·  docs/05_설계서/order/INF/INF-ORD-010.md
...
- **INF-ORD-011** `0.90` (화면 UIS-ORD-010)  GET /api/cart/  ·  docs/05_설계서/order/INF/INF-ORD-011.md
